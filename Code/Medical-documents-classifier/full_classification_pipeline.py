...
YEARS = (2011,)
MODELS = (9,)
WORDS = (80,)  # none means all
KNN_Ks = (10,)
MODEL_VALIDATION = True  # whether to validate the models or not. If false, the 2 params below are ignored
MODEL_VALIDATION_WORDS = (5, 25, 100, 500, 5000, 50000, 100000, 165000)  # words for ratio and random select
MODEL_VALIDATION_ONLY = False  # if true, no regular classification will be made
...
path_to_docs = "documents_array.json"
path_to_embeddings_folder = "Model{}"
...
for w2v_model in MODELS:
    ...
    for vocab, vocab_type, vocab_true_words in zip(all_vocabs, all_vocabs_types, all_vocabs_true_words):
        ...
        doc_space.doc_lab.reset()
        doc_space.doc_lab.update_vocab(vocab)
        ...
        for year in YEARS:
            ...
            for span in WORDS:
                ...
                if not os.path.isfile("fold_{}_span_{}.json".format(year, span)):  # if the fold doesn't exist as a file
                    ...
                    log.write("Creating fold for year {}".format(year))
                    print("Creating fold for year {}".format(year))
                ...
                train_labels, train_vectors = doc_space.get_abs_vectors(other_docs, "train")
                test_labels, test_vectors = doc_space.get_abs_vectors(year_docs, "test")
                log.write("Finished building vectors in {}.\n".format(datetime.now() - build_vectors_start))
                print("Finished building vectors in {}.\n".format(datetime.now() - build_vectors_start))

                log.write("Counting unks...\n")
                print("Counting unks...\n")

                count_log = doc_space.doc_lab.verbose_unk_lab()
                ...
                for K in KNN_Ks:
                    ...
                    log.write("Predicting with:\nModel = {}\nYear = {}\nSpan = {}\nK = {}\nVocab Length = {}\nVocab type = {}\n...\n".format(w2v_model, year, span, K, vocab_true_words, vocab_type))
